...
class ComicTagSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $typeTags = [
            'manga' => ['Сёнэн', 'Приключения', 'Боевые искусства', 'Сверхъестественное', 'Драма', 'Комедия'],
            'manhwa' => ['Романтика', 'Драма', 'Фэнтези', 'Перерождение', 'Исекай', 'Гарем'],
            'manhua' => ['Боевые искусства', 'Фэнтези', 'Перерождение', 'Исторический', 'Магия', 'Культивация'],
            'western' => ['Супергерои', 'Научная фантастика', 'Боевик', 'Детектив', 'Хоррор', 'Криминал'],
            'other' => ['Экспериментальный', 'Повседневность', 'Драма', 'Комедия', 'Философия', 'Психология']
        ];
